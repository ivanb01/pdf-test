...
const OnlineFormEmailTemplate = ({ formLink, first_name, agent_first_name, agent_last_name, email }) => {
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={mainContainer}>
            ...
            <Text style={paragraph}>
              {agent_first_name} {agent_last_name} has sent you an online form to complete. Please fill out the form by
              clicking the button below.
            </Text>
            <Text style={paragraph}>Regards,</Text>
            <Text style={paragraph}>{agent_first_name}</Text>
            <Section style={button}>
              <Link href={formLink} style={buttonText}>
                Open Online Form
              </Link>{' '}
            </Section>
          </Section>
...
export default OnlineFormEmailTemplate;
OnlineFormEmailTemplate.propTypes = {
