...
const EDITOR_HEADING1_LINE_HEIGHT = 28;
const EDITOR_HEADING1_MARGIN_BOTTOM = 12;
const EDITOR_HEADING2_SIZE = 20;
const EDITOR_HEADING2_LINE_HEIGHT = 24;
...
export const PDF_HEADING1_LINE_HEIGHT =
  (EDITOR_HEADING1_LINE_HEIGHT * TOTAL_RATIO) / (EDITOR_HEADING1_SIZE * TOTAL_RATIO);

export const PDF_HEADING2_SIZE = EDITOR_HEADING2_SIZE * TOTAL_RATIO;
export const PDF_HEADING2_LINE_HEIGHT =
  (EDITOR_HEADING2_LINE_HEIGHT * TOTAL_RATIO) / (EDITOR_HEADING2_SIZE * TOTAL_RATIO);
