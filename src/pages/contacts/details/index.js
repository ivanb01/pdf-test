            ...
            <div className='w-full lg:w-[290px]'>
              <div className='bg-white px-3 lg:px-6 py-[20px] client-details-box-shadow rounded-lg mb-3'>
                <div className='flex items-center justify-between'>
                  <div
                    className='bg-white rounded-full w-[105px] h-[105px] custom-box-shadow flex items-center justify-center'>
                    <img
                ...
                <div>
                  {contact.category_1 == 'Client' && contact.status_1 != 'Dropped' && (
                    <div
                      className='mb-[10px] w-full px-4 py-2 client-details-info-shadow border border-gray2 rounded-lg flex items-center text-sm font-medium '>
                  ...
                  {contact.lead_source && (
                    <div
                      className='w-full px-4 py-2 client-details-info-shadow border border-gray2 rounded-lg flex items-center text-sm font-medium '>
