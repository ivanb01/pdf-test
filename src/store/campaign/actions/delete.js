...
export const deleteCampaign = createAsyncThunk('campaigns/deleteCampaign', async (id, thunkAPI) => {
...
export const deleteContactFromCampaign = createAsyncThunk(
  ...
  async (payload, thunkAPI) => {
    const { data = {} } = await campaignServices.deleteContactFromCampaign(payload);
    return data;
  },
);
...
export const deleteClientFromCampaign = createAsyncThunk(
  ...
  async (payload, { dispatch }) => {
    const { data = {} } = await campaignServices.deleteClientFromCampaign(payload);
    if (data) {
