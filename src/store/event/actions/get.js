...
export const getEvents = createAsyncThunk('events/getEvents', async (thunkAPI) => {
...
export const getClientCampaignsAndEvents = createAsyncThunk(
  ...
  async (email, thunkAPI) => {
    const { data = {} } = await eventServices.getClientCampaignsAndEvents(email);
    return data;
  },
);
...
export const getContactCampaignsAndEvents = createAsyncThunk(
  ...
  async (email, thunkAPI) => {
    const { data = {} } = await eventServices.getContactCampaignsAndEvents(email);
    return data;
  },
);
