      ...
      <div className="p-6">
        <div className="mb-6 text-center">
          <div className="text-lg font-medium text-gray-900 mb-3">
            Setup Smart Sync & Google Contacts Import
          </div>
          <div className="text-xs text-gray-900">
            Setup “Smart Sync Contacts” and “Import Google Contacts” to be able
            to import contact directly from Gmail in the CRM.
          </div>
        </div>
        <div className="flex py-6">
          <div className="w-1/2 text-center border-r border-gray-200 pr-6">
            ...
            <div className="text-xs text-gray-500">
              ...
              swiftly identifying their type, status, and most importantly,
              their interests.
            </div>
          </div>
          <div className="w-1/2 text-center pl-6">
            ...
            <div className="text-xs text-gray-500">
              ...
              <br /> you will be able to import your contacts that are already
        ...
        <div className="flex items-center justify-between mt-6">
          <button
            className="text-lightBlue3 text-sm font-medium"
