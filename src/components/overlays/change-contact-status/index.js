        ...
        <div className="">
          <div className="">
            ...
            <Text p className="text-red5 justify-center text-center mb-4">
              If you change the status or type, contact will be unassign from
              the campaign!
            </Text>
            <Text p className="text-gray4 justify-center text-center ">
              But, you can always assign the contact to a different campaign
              based on the type and status you update.
            </Text>
