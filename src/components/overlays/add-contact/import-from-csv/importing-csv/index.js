...
const ImportingFromCsv = ({ title, handleClose, failed }) => {
  ...
  return (
    <Overlay handleCloseOverlay={handleClose} className="max-w-[600px]" title={title}>
      <div className="p-[24px]">
        <div className="text-left">
          <Input label="Document Name" className="mb-6" placeholder="Write your document name here" />
        </div>
          ...
          <div className="ml-[14px] mr-2 w-full">
            ...
            <div className="flex items-center justify-center">
              <div className="w-full bg-lightBlue2 h-2 my-[6px] rounded-lg">
                <div className={`${bgColor} h-2 rounded-lg`} style={{ width: failed ? '100%' : '50%' }}></div>
              </div>
            </div>
            <div className="flex items-center justify-between">
              ...
              <Text h4 className={`${failed ? 'text-red5' : 'text-gray4'} text-left`}>
