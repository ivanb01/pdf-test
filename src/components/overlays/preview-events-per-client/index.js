...
import { formatDateStringMDY, getInitials } from '@global/functions';
  ...
  return <SlideOver
    ...
    <div>
      ...
      {person?.contact_campaign_status === 'never_assigned' &&
        <>
          <div
            className={'p-4 border-l-4  border-[#FBBF24] -mx-6 flex  align-center gap-[12px] bg-yellow1'}>
            ...
            <p className={'text-sm leading-5 font-medium text-yellow3'}>In order to receive these events, you must
              “activate” campaign
              for this client.</p>
      ...
      <div className='flex -mx-6 h-full'>
        <div className='w-1/2'>
          <SimpleBar style={{
            maxHeight: person?.contact_campaign_status !== 'never_assigned' ? 'calc(100vh - 180px)' : 'calc(100vh - 235px)',
            height: '100vh',
          }}>
            <div className={'flex flex-col px-[22px] py-[26px] '}>
              <div className='mb-4 text-gray8 text-sm font-medium'>Events</div>
              {person?.contact_campaign_status === 'never_assigned' ? <div>
                            ...
                            <div className='flex items-center  justify-center'>
                              <div className='w-'>
                                {correspondingEvent?.event_status === 'canceled' ? (
                                  <svg width='38' height='39' viewBox='0 0 38 39' fill='none'
                                    ...
                                    <rect x='2' y='2.5' width='34' height='34' rx='17' stroke='#FEF2F2'
                                          stroke-width='4' />
                                    <g clip-path='url(#clip0_2699_54885)'>
                                      <path
                                ...
                                ) : correspondingEvent?.event_status === 'assigned' ? (
                                  <svg width='38' height='39' viewBox='0 0 38 39' fill='none'
                                       xmlns='http://www.w3.org/2000/svg'>
                                    <rect x='2' y='2.5' width='34' height='34' rx='17' fill='#10B981' />
                                    <rect x='2' y='2.5' width='34' height='34' rx='17' stroke='#ECFDF5'
                                          stroke-width='4' />
                                    <path
                                  ...
                                  <rect x='2' y='2.5' width='34' height='34' rx='17' stroke='#F3F4F6'
                                        stroke-width='4' />
                                  <path
                              ...
                              <div className='ml-4 text-sm flex flex-col gap-[6px]'>
                                ...
                                <div className={'flex gap-2'}>
                                  ...
                                  <div
                                    className='text-gray-500 font-inter font-medium text-sm leading-5'>on {formatDateStringMDY(e?.execute_date)}</div>
                                </div>
                              </div>
                            </div>
                            <KeyboardArrowRight className={`text-gray7`} />
