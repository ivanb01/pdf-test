...
const features = [
  {
    ...
    description: <p>Don&apos;t waste time - contacts are automatically synced with gmail.</p>,
  },
  {
    icon: iconDrive,
    title: 'Drive Campaigns',
    description: <p>Stay in touch, drive connections and don&apos;t lose contact.</p>,
  },
  {
    icon: iconAddTasks,
    title: 'Add Tasks',
    description: <p>Create automated to do list items, for yourself or your team.</p>,
  },
  {
    icon: iconConsumerWebsite,
    title: 'Consumer Websites',
    description: <p>Beautiful front end agent and brokerage website templates.</p>,
  },
  {
    icon: iconStatistics,
    title: 'See Statistics',
    description: <p>Track your productivity and your teams. Make sure your leads are generating ROI.</p>,
  },
  {
    icon: iconFeatureEmail,
    title: 'Email&SMS Communicating',
    description: <p>Stay top of mind with clients through text and email.</p>,
  },
  {
    ...
    <div className="container-public">
      <div className={styles.section}>
        ...
        <p className={styles['section__description']}>
          Payments, Lead Management, Front end Website, Agent roster and team management. Your Brokerage out of the box.
        </p>
        <div className={styles['section__features']}>
          {features.map((feature, i) => (
            <Feature key={'feature-' + i} item={feature} inRow={true} />
          ))}
        </div>
        <div className={styles['section__features-mobile']}>
          <Swiper modules={[Pagination]} speed={750} slidesPerView={1} pagination={{ clickable: true }}>
            <SwiperSlide key="feature-slide-1">
              {features
                .filter((s, slideIndex) => slideIndex < 4)
                .map((feature, i) => (
            ...
            <SwiperSlide key="feature-slide-2">
              {features
                .filter((s, slideIndex) => slideIndex > 3)
                .map((feature, i) => (
                  <Feature key={'feature-' + i} item={feature} iconLeft={true} />
                ))}
            </SwiperSlide>
