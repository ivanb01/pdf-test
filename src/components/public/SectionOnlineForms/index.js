...
const features = [
  {
    ...
    description: (
      <p>Our forms are integrated with your workflow, so we sent them without you having to think about it.</p>
    ),
  },
  {
    icon: iconChecklist,
    title: 'Create Your Own Custom Form',
    description: <p>Save your forms as templates, copy templates and use them for all clients.</p>,
  },
  {
    icon: iconEmail,
    title: 'Use Existing Template from the Library',
    description: (
      <p>Our library of 100&apos;s of forms makes it easy to get the document you need as fast as you need it.</p>
    ),
  },
];
