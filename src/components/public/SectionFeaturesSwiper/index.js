...
const slides = [
  {
    ...
    description: 'Streamline and optimize your sales pipeline with our CRM\'s powerful lead management solution. From capturing leads to nurturing prospects, stay in control and convert more opportunities into loyal customers.',
    mediaSource: featureSlide1,
    maxWidth: 416
  },
  {
    title: 'Manage Relationships',
    description: 'Elevate customer satisfaction and loyalty with our CRM\'s comprehensive customer relationship management tools. Seamlessly manage interactions, track preferences, and deliver personalized experiences to foster long-lasting connections.',
    mediaSource: featureSlide2,
    maxWidth: 612
  },
  {
    title: 'Organize Sales Funnel',
    description: 'Effortlessly organize and supercharge your sales funnel using our CRM\'s intuitive tools. From prospecting to closing deals, gain valuable insights and drive revenue growth with a streamlined and data-driven sales process.',
    mediaSource: featureSlide3,
    maxWidth: 410
  },
  {
    title: 'Drive Campaigns',
    description: 'Unleash the full potential of your marketing efforts with our CRM\'s dynamic campaign management. From ideation to execution, empower your team to drive impactful campaigns, analyze results, and achieve unmatched ROI',
  ...
  },
  {
    ...
    description: 'Simplify data collection and enhance customer engagement with our CRM\'s versatile Online Forms and Applications. Create customizable, user-friendly forms to gather valuable insights, process applications seamlessly, and optimize your business workflows with ease.',
  ...
  },
  {
    ...
    description: 'Offer an immersive and convenient property exploration experience with our CRM\'s \'Book Property Tour\' feature. Empower potential buyers to schedule tours effortlessly, while enabling your agents to efficiently manage and convert leads into delighted homeowners.',
  ...
  {
    title: 'Close Deals',
    description: 'Seal the deal with confidence using our CRM\'s powerful features. \n' +
  ...
  const renderPagination = (swiper, current, total) => {
    ...
    for (let i = 0; i < total; i++) {
      ...
      const element = (
        <div
          key={i}
          className={clsx(styles['pagination-element'], currentItemIndex === current && styles['pagination-element--active'])}>
          <div style={{backgroundImage: `url(${getPaginationImage(modifier)})`}} className={styles['pagination-element__image']}></div>
    ...
    <div className="container-public">
      <div className={styles.section}>
        ...
        <p className={styles['section__description']}>
          A streamlined process which automatically triggers pre-templated actions across
          every step of your clients journey to buying and renting a home.
        </p>
