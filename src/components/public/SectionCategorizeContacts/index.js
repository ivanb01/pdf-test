...
const slides = [
  {
    ...
    description: 'Save time. Syncs your contacts directly into your CRM. AI will identify type, status, and most importantly, the interests.',
      ...
      <div className="container-public">
        <div className={styles['section__inner']}>
          <div className={styles['section__intro']}>
            <h3>Categorize contacts with just <span>two clicks</span></h3>
            <p>
