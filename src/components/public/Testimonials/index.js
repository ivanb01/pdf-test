...
const testimonials = [
  {
    description: 'Oneline has helped me follow up with clients, I didn&apos;t even know were still engaged. Its a true end to end solution for agents and brokerages. Our clients, agents and our brokerage has benefited from signing up.',
    logo: levelLogo,
    name: 'John Doe',
    position: 'CEO, LEVEL',
  ...
  {
    description: 'We are a brokerage partner and use Oneline to run our entire operation. From CRM, to agent management, agent payments and deal management to website, marketing and support. Its the only product we have seen that provides everything.',
    logo: spireLogo,
...
export const Testimonials = () => {
  return <div className={styles['section-main-container']}>
    <Image src={testimonialsTop} alt="top-arc"/>
        ...
        >
          {
            testimonials.map((testimonial, i) => (
                <SwiperSlide key={'slide' + i}>
                  <div className={i %2 === 0 ? styles['section-swiper-container-left'] : styles['section-swiper-container-right']}>
    ...
    <Image src={testimonialsBottom} alt="bottom-arc"/>
  </div>;
};
