                                ...
                                <Popover.Panel
                                  ...
                                  <div className="p-4">
                                    {item.submenus.map((submenu) => (
                                      <div
                                        key={submenu.title}
                                        className={`${window.location.pathname == submenu.href && 'bg-gray-50'} group relative flex gap-x-6 rounded-lg p-4 text-sm leading-6 hover:bg-gray-50`}>
                      ...
                      {item.name}
                        ...
                        <a
                          ...
                          className={`cursor-pointer outline-none rounded-md ${
                            window.location.pathname == item.href ? 'bg-menuHover' : 'hover:bg-menuHover'
                          } px-3 py-2 text-sm font-medium text-white`}>
                          {item.title}
                        </a>
                      ),
