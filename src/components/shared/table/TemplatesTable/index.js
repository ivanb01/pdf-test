    ...
    <Table isInCampaign>
      ...
      {data.map((template) => (
        <tr
          ...
          <td
            className='px-3 py-2 text-left text-sm leading-5 md:w-[400px] lg:w-[600px] overflow-ellipsis break-word w-full overflow-hidden '>
            <p className={'text-sm leading-5 font-medium text-gray7'} style={{ fontWeight: 600 }}>Subject:</p>
