          ...
          <>
            ...
            <div className="mt-1 relative">
              <Listbox.Button
                ...
                }  relative w-full min-h-[38px] border-gray-300 pl-3 pr-10 py-[9px] text-left cursor-pointer focus:outline-none focus:ring-1 focus:ring-blue1 focus:border-blue1 sm:text-sm`}
              >
                <span
                  className={`${
