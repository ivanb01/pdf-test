...
const FilterDropdown = ({
  ...
  return (
    ...
    >
      ...
      >
        <Menu.Items className={`origin-top-right absolute ${positionClass ? positionClass : 'left-0'} mt-2 w-56 z-50 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none `}>
          <div className="py-1">
            {isFilter && (
              <Menu.Item>
                {({ active }) => (
